...
public class LaptopAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder){
            ...
            myViewHolder.giasp.setText("Giá: "+decimalFormat.format(Double.parseDouble(String.valueOf(sanPham.getGia())))+"Đ" );
            myViewHolder.mota.setText(sanPham.getMota());
            myViewHolder.soluong.setText("Số lượng: " + sanPham.getSltonkho());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            soluong = itemView.findViewById(R.id.itemlaptop_soluong);
